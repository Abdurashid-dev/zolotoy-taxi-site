        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 wow slideInUp" data-wow-duration="1s">
                <div class="card service">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a href="JavaScript:Void(0);"> Easily Managable </a></h5>
            ...
            <div class="col-12 col-lg-4 wow slideInUp" data-wow-duration="1s">
                <div class="card service">
                    <i class="lni-timer"></i>
                    <div class="card-body">
                        <h5 class="card-title">Track Your Move</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's content.</p>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="screenshot-slider owl-carousel owl-theme">
                    <div class="item">
                        <a href="app-landing-page/img/screenshot1.png" data-fancybox="group1" data-title="ScreenShot 1">
                            <img src="app-landing-page/img/screenshot1.png" alt="ScreenShota">
                        </a>
                    </div>
                    <div class="item">
                        <a href="app-landing-page/img/screenshot2.png" data-fancybox="group1" data-title="ScreenShot 2">
                            <img src="app-landing-page/img/screenshot2.png" alt="ScreenShotb">
                        </a>
                    </div>
                    <div class="item">
                        <a href="app-landing-page/img/screenshot3.png" data-fancybox="group1" data-title="ScreenShot 3">
                            <img src="app-landing-page/img/screenshot3.png" alt="ScreenShotc">
                        </a>
                    </div>
                    <div class="item">
                        <a href="app-landing-page/img/screenshot3.png" data-fancybox="group1" data-title="ScreenShot 3">
        ...
        <div class="row align-items-center text-center">
            ...
            <div class="col-lg-4 wow fadeInLeft mb-5 mb-lg-0" style="visibility: visible; animation-name: fadeInLeft;">
                ...
                <div class="app-feature">
                    <i class="lni-diamond gradient-text1"></i>
                ...
                <!--App deatil item-->
                <div class="app-feature">
                    <i class="lni-pencil-alt gradient-text1"></i>
            ...
            <div class="col-lg-4 wow fadeInUp mb-5 mb-lg-0">
                ...
                <div class="app-image">
                    ...
                    <div id="app-slider" class="owl-carousel owl-theme">
                        <div class="item">
                            <img src="app-landing-page/img/img3.png" alt="">
                        </div>
                        <div class="item">
                            <img src="app-landing-page/img/img3.png" alt="">
                        </div>
            ...
            <div class="col-lg-4 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                <!--App deatil item-->
                <div class="app-feature">
                    <i class="lni-code gradient-text1"></i>
                ...
                <!--App deatil item-->
                <div class="app-feature">
                    <i class="lni-files gradient-text1"></i>
